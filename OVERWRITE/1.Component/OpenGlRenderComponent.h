...
private:
    ...
    void draw_cyberpunk_surfaces() const;
    ...
    void draw_neon_panel_pair(float _z) const;
    ...
    void use_scene_shader(GLuint _shader_program) const;
    ...
    GLuint interior_shader_program = 0;
